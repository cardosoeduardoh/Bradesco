function getFrases_FalaPgmFidAngel(dados) {
	...
	ret['statOpcoes'] = "";
	ret['statInvalida_NOMATCH'] = "4019";
	ret['statInvalida_NOINPUT'] = "4019";
	ret['statInvalida_EXCEDEU_NOMATCH'] = "1145";
	ret['statInvalida_EXCEDEU_NOINPUT'] = "1145";
	ret['statValida'] = "";

	ret['retryTentativaNoMatch'] = true;
	ret['retryTentativaNoInput'] = true;
	
	ret['logTick'] = 'TICK_LOG_MPGMFIDEL';
